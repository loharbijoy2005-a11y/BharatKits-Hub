            ...
            for i in range(0, len(unique_jobs), batch_size):
                ...
                for item in batch:
                    ...
                    if cat in ("government", "teaching"):
                        ...
                        clean["last_date_to_apply"] = parsed_ld or raw_ld or "2026-10-30"
