...
export const INITIAL_JOBS_DATA: Job[] = [
  ...
  },
  {
    ...
    description: "Department of Posts online engagement for Gramin Dak Sevak (GDS), Branch Postmaster (BPM), and Assistant Branch Postmaster (ABPM) across all postal circles in India. Direct merit based selection on 10th marks.",
  ...
  },
  {
    ...
    fee_details: "Gen/OBC: ₹500 (₹400 refunded after CBT), SC/ST: ₹250",
    description: "Indian Railways invites applications for Non-Technical Popular Categories (NTPC) including Station Master, Goods Train Manager, Senior Clerk, Junior Account Assistant, and Commercial Apprentice across 21 RRBs.",
  ...
  },
  {
    ...
    description: "Recruitment of Constables and Lady Constables in West Bengal Police. Selection process includes Preliminary Written Test, PMT/PET, Final Written Exam, and Interview.",
    posted_date: "2026-09-03",
    is_active: true,
  },
  {
    ...
    description: "Bihar Public Service Commission Teacher Recruitment Examination (TRE 4.0) for Primary School Teachers (Class 1-5), Middle School (6-8), and Secondary/Higher Secondary School Teachers.",
