...
export const INITIAL_JOBS_DATA: Job[] = [
  ...
  {
    id: "govt-forest-guard-2026",
    job_hash: "forest-guard-2026-hash",
    category: "government",
    title: "State Forest Guard & Forester Recruitment 2026",
    sector: "Police & Defence",
    state: "All India",
    state_or_location: "All India",
    department_or_board: "State Forest & Environment Department",
    gov_sector: "Police & Defence",
    qualification: "10th Pass / 12th Pass",
    vacancies_count: 5400,
    last_date: "2026-11-25",
    last_date_to_apply: "2026-11-25",
    last_date_parsed: "2026-11-25",
    salary: "₹19,900 - ₹63,200 (Level 2 & 4)",
    salary_range: "₹19,900 - ₹63,200",
    apply_url: "https://forest.gov.in/",
    notification_pdf_url: "https://forest.gov.in/",
    official_pdf_fallback: "https://forest.gov.in/",
    has_direct_pdf: false,
    age_limit: "18 - 28 Years",
    fee_details: "Gen/OBC: ₹100, SC/ST: ₹0",
    description: "State Forest Department recruitment for Forest Guards, Foresters, and Wildlife Rangers. Physical Efficiency Test (Walking/Running) followed by Written Examination.",
    posted_date: "2026-09-04",
    is_active: true,
  },
  {
    id: "govt-postman-mailguard-2026",
    job_hash: "postman-mailguard-hash",
    category: "government",
    title: "India Post Postman & Mail Guard Recruitment 2026",
    sector: "Panchayat & Postal",
    state: "All India",
    state_or_location: "All India",
    department_or_board: "Department of Posts (India Post)",
    gov_sector: "Panchayat & Postal",
    qualification: "12th Pass + Local Language Knowledge",
    vacancies_count: 18900,
    last_date: "2026-11-30",
    last_date_to_apply: "2026-11-30",
    last_date_parsed: "2026-11-30",
    salary: "₹21,700 - ₹69,100 (Level 3 Pay Matrix)",
    salary_range: "₹21,700 - ₹69,100",
    ...
    age_limit: "18 - 27 Years",
    fee_details: "Gen/OBC: ₹100, SC/ST/Women: ₹0",
    description: "Department of Posts cadre recruitment for Postman and Mail Guard vacancies across all Postal Circles in India.",
  ...
  {
    id: "govt-wbpsc-clerkship-2026",
    job_hash: "wbpsc-clerkship-2026-hash",
    category: "government",
    title: "WBPSC Clerkship Examination 2026 (LDA / LDC Posts)",
    ...
    qualification: "10th Pass / Madhyamik + Computer Knowledge",
    vacancies_count: 6000,
    last_date: "2026-11-05",
    last_date_to_apply: "2026-11-05",
    last_date_parsed: "2026-11-05",
    salary: "₹22,700 - ₹58,500 (Pay Level 6 WB ROPA)",
    salary_range: "₹22,700 - ₹58,500",
    ...
    has_direct_pdf: false,
    age_limit: "18 - 40 Years",
    fee_details: "Gen/OBC: ₹110, SC/ST/PWD (WB): ₹0",
    description: "WBPSC invites online applications for Lower Division Assistant (LDA), Lower Division Clerk (LDC) in West Bengal Secretariat, Directorates, and District Offices.",
    posted_date: "2026-09-04",
    is_active: true,
  },
  {
    id: "govt-wb-food-si-2026",
    job_hash: "wb-food-si-2026-hash",
    category: "government",
    title: "West Bengal Food SI (Sub-Inspector Food & Supplies) Recruitment",
    sector: "State PSC & Subordinate",
    state: "West Bengal",
    state_or_location: "West Bengal",
    department_or_board: "WB Food & Supplies Department / WBPSC",
    gov_sector: "State PSC & Subordinate",
    qualification: "10th Pass / Madhyamik",
    vacancies_count: 480,
    last_date: "2026-10-30",
    ...
    has_direct_pdf: false,
    age_limit: "18 - 40 Years",
    fee_details: "Gen/OBC: ₹110, SC/ST/PWD: ₹0",
    description: "Sub-Inspector Grade III in the Subordinate Food & Supplies Service, Grade III under Food & Supplies Department, Govt. of West Bengal.",
    posted_date: "2026-09-04",
    is_active: true,
  },
  {
    id: "govt-wb-primary-tet-2026",
    job_hash: "wb-primary-tet-2026-hash",
    category: "teaching",
    title: "West Bengal Primary School Teacher Recruitment 2026 (WB TET)",
    sector: "Teaching & Education",
    state: "West Bengal",
    state_or_location: "West Bengal",
    department_or_board: "West Bengal Board of Primary Education (WBBPE)",
    gov_sector: "Teaching & Education",
    qualification: "D.El.Ed / D.Ed / WB Primary TET Qualified",
    vacancies_count: 11765,
    last_date: "2026-11-20",
    last_date_to_apply: "2026-11-20",
    last_date_parsed: "2026-11-20",
    salary: "₹28,900 - ₹74,400 (Basic Pay + HRA + DA)",
    salary_range: "₹28,900 - ₹74,400",
    apply_url: "https://wbbpe.org/",
    notification_pdf_url: "https://wbbpe.org/",
    official_pdf_fallback: "https://wbbpe.org/",
    has_direct_pdf: false,
    age_limit: "18 - 40 Years",
    fee_details: "Gen: ₹500, OBC: ₹400, SC/ST/PH: ₹250",
    description: "Engagement of Assistant Teachers in Govt. Aided / Sponsored Primary Schools across all West Bengal districts.",
    posted_date: "2026-09-03",
    is_active: true,
  },
  {
