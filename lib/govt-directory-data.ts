...
export const govtServices: ServiceItem[] = [
  ...
  {
    id: "pan-protean-nsdl",
    title: "Protean PAN Portal (NSDL e-Gov)",
    description: "Apply for new Physical PAN Card (Form 49A/49AA), update name/photo/DOB, or request reprint of lost PAN card.",
    url: "https://www.protean-tinpan.com/services-pan/pan-index.html",
    category: "identity",
    tags: ["nsdl pan", "protean pan", "new pan card", "pan correction", "pan change", "physical pan card", "tin nsdl"],
    featured: true,
  },
  {
    id: "pan-utiitsl",
