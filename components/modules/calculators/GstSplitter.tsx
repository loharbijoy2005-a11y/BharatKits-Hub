    ...
    <div className="grid grid-cols-1 lg:grid-cols-12 gap-8">
      ...
      <div className="lg:col-span-5 space-y-6">
        <div className="utility-card p-6 rounded-3xl border shadow-sm space-y-5">
          ...
          <div className="space-y-2">
            <label className="text-xs font-bold text-slate-700 dark:text-slate-400 uppercase tracking-wide">Base Amount</label>
            <div className="flex gap-2.5">
              <select
                value={currency}
                onChange={(e) => setCurrency(e.target.value)}
                className="w-20 px-2 py-2.5 rounded-xl border border-slate-200 dark:border-slate-800 bg-white dark:bg-slate-900 text-sm font-bold focus:outline-none focus:ring-2 focus:ring-brand-500/50 text-slate-800 dark:text-slate-200"
              >
              ...
              <input
                ...
                className="w-full px-3 py-2.5 rounded-xl border border-slate-200 dark:border-slate-800 bg-transparent text-sm focus:outline-none focus:ring-2 focus:ring-brand-500/50 font-extrabold text-slate-800 dark:text-slate-200"
              />
            </div>
          </div>
          ...
          {/* Inclusive / Exclusive */}
          <div className="space-y-2">
            <label className="text-xs font-bold text-slate-700 dark:text-slate-400 uppercase tracking-wide">GST Treatment</label>
            <div className="grid grid-cols-2 gap-2 bg-slate-100/50 dark:bg-slate-950 p-1 rounded-xl border border-slate-200/50 dark:border-slate-800">
              <button
                type="button"
          ...
          {/* Rates preset */}
          <div className="space-y-2">
            <label className="text-xs font-bold text-slate-700 dark:text-slate-400 uppercase tracking-wide">GST Rate (%)</label>
            ...
            <div className="flex items-center gap-2 mt-2">
              ...
              <input
                ...
                className="w-full px-3 py-1.5 rounded-lg border border-slate-200 dark:border-slate-800 bg-transparent text-xs focus:outline-none focus:ring-2 focus:ring-brand-500/50 text-slate-800 dark:text-slate-200"
              />
            </div>
          </div>
          ...
          <div className="space-y-2 border-t border-slate-200 dark:border-slate-800 pt-4">
            <div className="flex justify-between items-center text-xs font-bold text-slate-700 dark:text-slate-400 uppercase tracking-wide">
              ...
              <input
                ...
                className="w-12 text-center bg-transparent border-b border-slate-300 dark:border-slate-700 focus:border-brand-500 focus:outline-none font-bold text-slate-800 dark:text-slate-200"
              />
            </div>
            <input
              type="range"
      ...
      <div className="lg:col-span-7 space-y-6">
        ...
        <div className="utility-card p-6 rounded-3xl border shadow-sm space-y-6">
          ...
          {/* Add Item form */}
          <div className="grid grid-cols-1 sm:grid-cols-12 gap-3 items-end bg-slate-50 dark:bg-slate-950 p-4 rounded-2xl border border-slate-200 dark:border-slate-900">
            <div className="sm:col-span-4">
              ...
              <input
                ...
                className="w-full mt-1.5 px-3 py-2 rounded-lg border border-slate-200 dark:border-slate-800 bg-white dark:bg-slate-900 text-xs focus:outline-none focus:ring-2 focus:ring-brand-500/50 text-slate-800 dark:text-slate-200"
              />
            </div>
            ...
            <div className="sm:col-span-2">
              ...
              <select
                ...
                className="w-full mt-1.5 px-2 py-2 rounded-lg border border-slate-200 dark:border-slate-800 bg-white dark:bg-slate-900 text-xs focus:outline-none focus:ring-2 focus:ring-brand-500/50 text-slate-800 dark:text-slate-200"
              >
            ...
            <div className="sm:col-span-3 flex items-center justify-between gap-2 mt-2 sm:mt-0">
              <label className="flex items-center gap-1.5 cursor-pointer select-none">
                <input
                  ...
                  className="w-3.5 h-3.5 text-brand-650 rounded border-slate-300"
                />
