...
export function TirangaBanner() {
  return (
    <div className="relative overflow-hidden bg-slate-900 text-white select-none shadow-xs">
      ...
      {/* Gentle Silk Sheen Light Animation across the banner (Does not move colors back and forth) */}
      ...
      <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8 py-2 relative z-10 flex flex-wrap items-center justify-between gap-2 text-xs">
        ...
        {/* Left Side: Patriotic Badge & Smooth Spinning Ashoka Chakra */}
        <div className="flex items-center gap-2.5">
          <div className="relative w-6 h-6 flex items-center justify-center shrink-0">
            {/* Spinning Ashoka Chakra SVG */}
            <svg
              viewBox="0 0 100 100"
              className="w-5.5 h-5.5 text-blue-400 animate-ashoka-spin drop-shadow-sm"
              fill="currentColor"
            >
          ...
          <div className="flex items-center gap-2">
            <span className="font-extrabold tracking-wide uppercase px-2 py-0.5 rounded-md bg-gradient-to-r from-orange-500 via-white to-emerald-600 text-slate-950 text-[10px] shadow-xs">
              🇮🇳 JAI HIND
            </span>
            <span className="font-bold text-slate-100 hidden sm:inline-block">
              BharatKits Hub • Digital India Citizen &amp; Cyber Cafe Portal
            </span>
          </div>
        </div>
