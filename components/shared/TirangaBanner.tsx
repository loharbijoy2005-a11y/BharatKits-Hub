        ...
        <div className="flex items-center justify-between w-full">
          <div className="flex items-center gap-2">
            ...
            <span className="font-bold text-slate-800 dark:text-slate-200 text-xs">
              BharatKits Hub • Dedicated to Indian Citizens &amp; Cyber Cafes
            </span>
          </div>

          {/* Center Ashoka Chakra */}
          <div className="hidden sm:flex items-center justify-center p-1 rounded-full bg-blue-50/90 dark:bg-blue-950/40 border border-blue-200 dark:border-blue-800 shadow-2xs">
            <div className="relative w-5 h-5 flex items-center justify-center shrink-0">
              <svg
                viewBox="0 0 100 100"
                className="w-5 h-5 text-[#000080] dark:text-blue-400 animate-ashoka-spin drop-shadow-xs"
                fill="currentColor"
              >
